...
<head>
    ...
    <link href="admin-temp/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css" rel="stylesheet" type="text/css" media="screen"/>
...
<body>
    ...
    <section id="container" >
      ...
      <header class="header white-bg">
          ...
          <!--logo start-->
          <a href="index.html" class="logo">REVERSE<span>DASHBOARD</span></a>
          <!--logo end-->
...
msg.innerHTML = "Order number: ";
    $(this).click(function(){
      ...
      var id_order = $(this).find('.id_order_val').html();
