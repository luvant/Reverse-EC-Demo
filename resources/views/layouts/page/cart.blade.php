...
@section('content')
<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(principal/images/heading-pages-01.jpg);">
				...
				<div class="wrap-table-shopping-cart bgwhite">
					<table class="table-shopping-cart">
						...
						<tr class="table-row">
							...
							<td class="column-4">
								<div class="idProduct" style="visibility: hidden">{{$item->id}}</div>
